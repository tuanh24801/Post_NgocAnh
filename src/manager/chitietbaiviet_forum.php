        ...
        <div class="comments mt-2 border-top border-2 p-3">
            <form action="" method="post">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="commentator_" value="Admin" disabled>
                    <input type="hidden" class="form-control" name="commentator" value="Admin">
                    <div id="emailHelp" class="form-text">Bình luận bời admin</div>
                </div>
